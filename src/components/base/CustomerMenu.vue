                ...
                <div v-if="wrapper" class="menu__wrapper" @click.stop>
                    <div class="menu__content">
                        ...
                        <div v-if="isLogin" class="menu__body">
                            <router-link @click="close" to="/coin-actions/profile" class="menu__item" :class="{ '-active': activeRoute === 'Profile' }">
                                <UserIcon class="menu__itemIcon" />
                                <span class="menu__text">Profilim</span>
                            </router-link>
                            <router-link @click="close" to="/coin-actions/address" class="menu__item" :class="{ '-active': activeRoute === 'Address' }">
                        ...
                        <div v-else class="menu__body">
                            <router-link @click="close" to="/coin-actions/login" class="menu__item">
                                <LoginIcon class="menu__itemIcon" />
                                <span class="menu__text">Giriş Yap</span>
                            </router-link>
                            <router-link @click="close" to="/coin-actions/register" class="menu__item">
